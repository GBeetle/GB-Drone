...
#define TOUCHSCREEN_RESISTIVE_PIN_YU CONFIG_DISP_TOUCHSCREEN_RESSITIVE_PIN_YU // Y+ any gpio
#define TOUCHSCREEN_RESISTIVE_PIN_YD CONFIG_DISP_TOUCHSCREEN_RESISTIVE_PIN_YD // Y- also ADC
#define TOUCHSCREEN_RESISTIVE_PIN_XL CONFIG_DISP_TOUCHSCREEN_RESISTIVE_PIN_XL // X- any gpio
#define TOUCHSCREEN_RESISTIVE_PIN_XR CONFIG_DISP_TOUCHSCREEN_RESISTIVE_PIN_XR // X+ also ADC
...
/*GetMaxX Macro*/
#if CONFIG_DISPLAY_ORIENTATION_LANDSCAPE

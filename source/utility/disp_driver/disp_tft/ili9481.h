 ...
 *      DEFINES
 *********************/
#define ILI9481_DC   CONFIG_DISP_PIN_DC
#define ILI9481_RST  CONFIG_DISP_PIN_RST
#define ILI9481_BCKL CONFIG_DISP_PIN_BCKL

#define ILI9481_ENABLE_BACKLIGHT_CONTROL CONFIG_ENABLE_BACKLIGHT_CONTROL
#define ILI9481_INVERT_COLORS CONFIG_INVERT_COLORS
#define ILI9481_DISPLAY_ORIENTATION CONFIG_DISPLAY_ORIENTATION

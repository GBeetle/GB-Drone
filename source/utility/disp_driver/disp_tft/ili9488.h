 ...
 *      DEFINES
 *********************/
#define ILI9488_DC   CONFIG_DISP_PIN_DC
#define ILI9488_RST  CONFIG_DISP_PIN_RST
#define ILI9488_BCKL CONFIG_DISP_PIN_BCKL

#define ILI9488_ENABLE_BACKLIGHT_CONTROL CONFIG_ENABLE_BACKLIGHT_CONTROL

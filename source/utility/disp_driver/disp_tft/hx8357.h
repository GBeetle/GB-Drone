 ...
 *      DEFINES
 *********************/
#define HX8357_DC   CONFIG_DISP_PIN_DC
#define HX8357_RST  CONFIG_DISP_PIN_RST
#define HX8357_BCKL CONFIG_DISP_PIN_BCKL

#define HX8357_ENABLE_BACKLIGHT_CONTROL CONFIG_ENABLE_BACKLIGHT_CONTROL
#define HX8357_INVERT_COLORS            CONFIG_INVERT_COLORS

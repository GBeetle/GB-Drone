...
void ili9481_init(void)
{
    ...
    GB_GPIO_Reset(ILI9481_DC);
    GB_GPIO_SetDirection(ILI9481_DC, GB_GPIO_OUTPUT);
    GB_GPIO_Reset(ILI9481_RST);
    GB_GPIO_SetDirection(ILI9481_RST, GB_GPIO_OUTPUT);

#if ILI9481_ENABLE_BACKLIGHT_CONTROL
    GB_GPIO_Reset(ILI9481_BCKL);
    GB_GPIO_SetDirection(ILI9481_BCKL, GB_GPIO_OUTPUT);
#endif

    //Reset the display
    GB_GPIO_Set(ILI9481_RST, 0);
    vTaskDelay(100 / portTICK_RATE_MS);
    GB_GPIO_Set(ILI9481_RST, 1);
    vTaskDelay(100 / portTICK_RATE_MS);

    GB_DEBUGI(DISP_TAG, "ILI9481 initialization.");
...
static void ili9481_send_cmd(uint8_t cmd)
{
    ...
    GB_GPIO_Set(ILI9481_DC, 0);	 /*Command mode*/
...
{
    disp_wait_for_pending_transactions();
    GB_GPIO_Set(ILI9481_DC, 1);	 /*Data mode*/

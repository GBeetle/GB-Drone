...
#define ST7735S_DC   CONFIG_DISP_PIN_DC
#define ST7735S_RST  CONFIG_DISP_PIN_RST

#define AXP192_SDA   CONFIG_AXP192_PIN_SDA
#define AXP192_SCL   CONFIG_AXP192_PIN_SCL

#define ST7735S_INVERT_COLORS CONFIG_INVERT_COLORS

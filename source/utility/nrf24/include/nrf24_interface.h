...
typedef uint8_t rf24_addr_handle_t;
...
struct rf24 {
     ...
     */
    GB_RESULT (*read_registers)(struct rf24 *nrf24, uint8_t reg, uint8_t* buf, uint8_t len);
     ...
     * byte, but that it now saved to a private member on all SPI transactions.
     */
    GB_RESULT (*write_register)(struct rf24 *nrf24, uint8_t reg, uint8_t value, bool is_cmd_only);
     ...
     * byte, but that it now saved to a private member on all SPI transactions.
     */
    GB_RESULT (*write_registers)(struct rf24 *nrf24, uint8_t reg, const uint8_t* buf, uint8_t len);
     ...
     * previously called.
     */
    GB_RESULT (*_init_radio)();

    /**
     * initialize the GPIO pins
     */
    GB_RESULT (*_init_pins)();
     ...
     * @endcode
     * @return
     * - `GB_OK` if the radio was successfully initialized
     * - `GB_FAIL` if the MCU failed to communicate with the radio hardware
     */
    GB_RESULT (*begin)(struct rf24 *nrf24);
     ...
     */
    GB_RESULT (*csn)(struct rf24 *nrf24, bool mode);
     ...
     */
    GB_RESULT (*ce)(struct rf24 *nrf24, bool level);
     ...
     * byte, but that it now saved to a private member on all SPI transactions.
     */
    GB_RESULT (*write_payload)(struct rf24 *nrf24, const void* buf, uint8_t len, const uint8_t writeType);
     ...
     * byte, but that it now saved to a private member on all SPI transactions.
     */
    GB_RESULT (*read_payload)(struct rf24 *nrf24, void* buf, uint8_t len);
     ...
     * functionality.
     */
    GB_RESULT (*startListening)(struct rf24 *nrf24);
     ...
     */
    GB_RESULT (*stopListening)(struct rf24 *nrf24);
     ...
     * @endcode
     */
    GB_RESULT (*read)(struct rf24 *nrf24, void* buf, uint8_t len);
     ...
     *   is on.
     */
    GB_RESULT (*write)(struct rf24 *nrf24, const void* buf, uint8_t len);
    ...
    GB_RESULT (*openWritingPipeAddr)(struct rf24 *nrf24, const uint8_t* address);
     ...
     */
    GB_RESULT (*openReadingPipeAddr)(struct rf24 *nrf24, uint8_t number, const uint8_t* address);
     ...
     * @endcode
     */
    GB_RESULT (*powerDown)(struct rf24 *nrf24);
     ...
     */
    GB_RESULT (*powerUp)(struct rf24 *nrf24);
     ...
     * @endcode
     */
    GB_RESULT (*write_data)(struct rf24 *nrf24, const void* buf, uint8_t len, const bool multicast);
     ...
     * @endcode
     */
    GB_RESULT (*writeFast)(struct rf24 *nrf24, const void* buf, uint8_t len);
     ...
     * @endcode
     */
    GB_RESULT (*writeFast_data)(struct rf24 *nrf24, const void* buf, uint8_t len, const bool multicast);
     ...
     *   is on.
     */
    GB_RESULT (*writeBlocking)(struct rf24 *nrf24, const void* buf, uint8_t len, uint32_t timeout);
     ...
     * @endcode
     */
    GB_RESULT (*startFastWrite)(struct rf24 *nrf24, const void* buf, uint8_t len, const bool multicast, bool startTx);
     ...
     * @endcode
     */
    GB_RESULT (*startWrite)(struct rf24 *nrf24, const void* buf, uint8_t len, const bool multicast);
     ...
     */
    GB_RESULT (*reUseTX)(struct rf24 *nrf24);
     ...
     */
    GB_RESULT (*flush_tx)(struct rf24 *nrf24);
     ...
     * @return Current value of status register
     */
    GB_RESULT (*flush_rx)(struct rf24 *nrf24);
     ...
     */
    GB_RESULT (*isValid)(struct rf24 *nrf24);
     ...
     * is ignored.
     */
    GB_RESULT (*closeReadingPipe)(struct rf24 *nrf24, uint8_t pipe);
     ...
     * 5.
     */
    GB_RESULT (*setAddressWidth)(struct rf24 *nrf24, uint8_t a_width);
     ...
     */
    GB_RESULT (*setRetries)(struct rf24 *nrf24, uint8_t delay, uint8_t count);
     ...
     */
    GB_RESULT (*setChannel)(struct rf24 *nrf24, uint8_t channel);
     ...
     */
    GB_RESULT (*setPayloadSize)(struct rf24 *nrf24, uint8_t size);
     ...
     */
    GB_RESULT (*setPALevel)(struct rf24 *nrf24, uint8_t level, bool lnaEnable);
     ...
     */
    GB_RESULT (*maskIRQ)(struct rf24 *nrf24, bool tx_ok, bool tx_fail, bool rx_ready);
     ...
     */
    GB_RESULT (*setRadiation)(struct rf24 *nrf24, uint8_t level, rf24_datarate_e speed, bool lnaEnable);
     ...
     */
    GB_RESULT (*openReadingPipe)(struct rf24 *nrf24, uint8_t number, uint64_t address);
     ...
     * @param address The 40-bit address of the pipe to open.
     */
    GB_RESULT (*openWritingPipe)(struct rf24 *nrf24, uint64_t address);
     ...
     */
    GB_RESULT (*toggle_features)(struct rf24 *nrf24);
